...
namespace Microsoft.Win32.TaskScheduler
{
    ...
    public sealed class TaskSettings : IDisposable
    {
        ...
        public bool StopIfGoingOnBatteries
        {
            get
            {
                ...
                return (v1Task.GetFlags() & V1Interop.TaskFlags.KillIfGoingOnBatteries) ==
                       V1Interop.TaskFlags.KillIfGoingOnBatteries;
            }
            set
            {
                if (v2Settings != null)
        ...
        public bool DisallowStartIfOnBatteries
        {
            get
            {
                ...
                return (v1Task.GetFlags() & V1Interop.TaskFlags.DontStartIfOnBatteries) ==
                       V1Interop.TaskFlags.DontStartIfOnBatteries;
            }
            set
            {
                if (v2Settings != null)
        ...
        public bool RunOnlyIfLoggedOn
        {
            get
            {
                if (v2Settings != null)
                    return true;
                return (v1Task.GetFlags() & V1Interop.TaskFlags.RunOnlyIfLoggedOn) ==
                       V1Interop.TaskFlags.RunOnlyIfLoggedOn;
            }
            set
            {
        ...
        public bool RunOnlyIfNetworkAvailable
        {
            get
            {
                ...
                return (v1Task.GetFlags() & V1Interop.TaskFlags.RunIfConnectedToInternet) ==
                       V1Interop.TaskFlags.RunIfConnectedToInternet;
            }
            set
            {
                if (v2Settings != null)
    ...
    public sealed class IdleSettings : IDisposable
    {
        ...
        public bool RestartOnIdle
        {
            get
            {
                ...
                return (v1Task.GetFlags() & V1Interop.TaskFlags.RestartOnIdleResume) ==
                       V1Interop.TaskFlags.RestartOnIdleResume;
            }
            set
            {
                if (v2Settings != null)
        ...
        public TaskLogonType LogonType
        {
            ...
            set
            {
                ...
                else
                {
                    ...
                    if (value == TaskLogonType.Group || value == TaskLogonType.InteractiveTokenOrPassword ||
                        value == TaskLogonType.None || value == TaskLogonType.Password || value == TaskLogonType.S4U)
                        throw new NotV1SupportedException();
                }
            }
        }
        ...
        internal void V1Save(string newName)
        {
            if (v1Task != null)
            {
                ...
                else
                {
                    ...
                    iFile.Save(
                        System.IO.Path.GetDirectoryName(path) + System.IO.Path.DirectorySeparatorChar + newName +
    ...
    public class Task : IDisposable
    {
        ...
        internal static TimeSpan StringToTimeSpan(string input)
        {
            ...
            {
                System.Text.RegularExpressions.Match m = System.Text.RegularExpressions.Regex.Match(input,
                                                                                                    "P(?:(?<Y>[0-9]*)Y)?(?:(?<Mo>[0-9]*)M)?(?:(?<D>[0-9]*)D)?T(?:(?<H>[0-9]*)H)?(?:(?<M>[0-9]*)M)?(?:(?<S>[0-9]*)S)?",
                                                                                                    System.Text.
                                                                                                        RegularExpressions
                                                                                                        .RegexOptions.
                                                                                                        IgnoreCase |
                ...
                if (m.Success)
                {
                    ...
                    if (years > 0 || months > 0)
                        days +=
                            (now - new DateTime(now.Year + years + (now.Month + months)/12, (now.Month + months)%12, 1))
                                .Days;
        ...
        public DateTime[] GetRunTimes(DateTime start, DateTime end)
        {
            if (v2Task != null)
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    ret[i] =
                        (TaskScheduler.V1Interop.SystemTime)
                        Marshal.PtrToStructure(st, typeof (TaskScheduler.V1Interop.SystemTime));
